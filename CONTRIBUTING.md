Le projet requière php 8.1 et a été développé avec Symfony 6.0. De plus, il est essentiel de connaître [Git](https://git-scm.com/doc) & [GitHub](https://help.github.com/en).
